...
//#define height (46.0)
#define TC_CUR_PLAY_TIME_LABEL_LEFT_RATIO (0.10f)
...
- (instancetype)init
{
    ...
    if (self)
    {
        ...
        [_playPauseButton setImage:[UIImage imageNamed: @"kr-video-player-play"] forState:UIControlStateNormal];
        [_playPauseButton setImage:[UIImage imageNamed: @"kr-video-player-pause"] forState:UIControlStateSelected];
...
#pragma clang diagnostic pop
        ...
        _movieTimeControl.maximumTrackTintColor = [UIColor blackColor];
        _movieTimeControl.minimumTrackTintColor = RGBAColor(136,131,109,1);
